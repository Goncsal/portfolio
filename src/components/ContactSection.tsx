const ContactSection = () => {
    return (
        ...
        >
            {/* Title at top */}
            <div className="pt-24 pb-8 w-full text-center px-8 md:px-16 lg:px-24">
                        ...
                        <div className="text-center">
                            ...
                            <div className="flex flex-col items-center space-y-6">
                                <a
                                    ...
                                    className="flex items-center gap-4 text-lg transition-colors hover:text-[var(--accent-primary)]"
                                ...
                                >
                                    ...
                                    <span>goncalodfalmeida1@gmail.com</span>
                                </a>
            ...
            <div className="pb-8 w-full text-center">
                <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
                    © {new Date().getFullYear()} Gonçalo Almeida. All rights reserved.
                </p>
            </div>
        </section>
    )
